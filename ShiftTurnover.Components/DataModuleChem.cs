...
namespace ShiftTurnover.Components
{
	...
	public class DataModuleChem
	{
		...
		public DataModuleChem()
		{
            string b = System.Web.Configuration.WebConfigurationManager.AppSettings["sqlconnChem"];
        ...
        {
            string b = System.Configuration.ConfigurationManager.AppSettings["sqlconnChem"];
            Encryption comn = new Encryption ();
