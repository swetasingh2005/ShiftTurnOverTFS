...
namespace ShiftTurnover.Components
{
	...
	public class DataModule
	{
        ...
        public DataSet GetDataSet(string StoredProcName)
        {
            ...
            {
                ErrorHandler.LogErrorToDB(100, 100, "DataModule.GetDataSet", StoredProcName, ex);

                throw new Exception("Error in ShiftTurnover.Components.DataModule.GetDataSet " + ex.Message, ex);
            }
            finally
            {
                if (cnn != null)
		...
		public DataSet GetDataSetInLineQuery(string inlinequery)
		{
			...
			{
				throw new Exception("Error in ShiftTurnover.Components.DataModule.GetDataSetInLineQuery " + ex.Message,ex);
			}
			finally
			{
				cnn.Close();
