<%@ Page Title=" " Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="NewTurnover_BlrStatus.aspx.cs" Inherits="ShiftTurnover.NewTurnover_BlrStatus" %>
        ...
        $(document).ready(function () {
          ShowProgress();
             $.ajax({
                ...
                url: 'NewTurnover_BlrStatus.aspx/GetData',
                data: '{}',
                success:
                    function (response) {
                    ...
                    <center>
                           <div class="row"  >
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center  bhoechie-tab-container" style="border:solid 0px Black;">
                                       <h1><asp:Label ID="lblHeader" runat="server" Text="Boilers  Status"></asp:Label>
                                            <a href="CheckStatus.aspx?PID=5" target="_blank" title="Click here to enlarge the chart in seperate window"><img src="Images/retro-tv-icon.jpg" style="width:50px; height:40px" /></a>
                                       <br />
                      <asp:Label runat="server" ID="lblMShift"  Font-Size="Medium" ForeColor="Black"      ></asp:Label>
                                      ...
                                      <div class="row" style="padding-left:5px;padding-right:5px; border:solid 0px Black;"> 
                                          ...
                                          <div id="CHLChart"  style="width:780px; height:540px;"     ></div>  
                                              </div>
                                      ...
                                      <div class="row" style="padding-left:35px;padding-right:35px;" > 
                                           <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                  <div><strong>Is the data correct?<img height="12" alt="Required" src="Images/icon_required.gif" width="13" /></strong></div>

                                           </div>
                                           <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                        <asp:RadioButtonList runat="server" ID="rdoYN" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdoBoiler_SelectedIndexChanged">
