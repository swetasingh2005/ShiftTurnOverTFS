...
{
    public partial class NewTurnover_ChlPmpStatus : System.Web.UI.Page
    {
        ...
        protected void LoadStatus()
        {
            try
            {
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            rdoYN.SelectedValue = row["ChillerPumpYN"].ToString();
                            txtComment.Text = row["ChillerPumpComments"].ToString();
                        }
            ...
            {
                ErrorHandler.LogErrorToDB((int)Session["personid"], "NewTurnOver_ChlPmpStatus.LoadStatus", "SelectReportDetails", ex);
        ...
        protected void rdoCHLPump_SelectedIndexChanged(object sender, EventArgs e)
        {
            ShowHideComment(rdoYN.SelectedValue);
        }
        ...
        protected void SaveStatus()
        {
            try
            {
                ...
                _dm.AddParameter("@ChillerPumpYN", SqlDbType.VarChar, rdoYN.SelectedValue);
                _dm.AddParameter("@ChillerPumpComments", SqlDbType.VarChar, Comments);
                _dm.ExecuteCommand("AddEditReportInfo");
            }
            catch (Exception ex)
            {
                ErrorHandler.LogErrorToDB(18, "NewTurnOver_ChlPmpStatus.SaveStatus", "AddEditReportInfo", ex);
