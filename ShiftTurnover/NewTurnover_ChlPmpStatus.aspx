<%@ Page Title=" " Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="NewTurnover_ChlPmpStatus.aspx.cs" Inherits="ShiftTurnover.NewTurnover_ChlPmpStatus" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
         ShowProgress();
             $.ajax({
                ...
                url: 'NewTurnover_ChlPmpStatus.aspx/GetData',
                data: '{}',
                success:
                    function (response) {
        ...
        function drawChart(dataValues) {
            ...
            for (var i = 0; i < dataValues.length; i++) {
                ...
                console.log(dataValues[i].ChillerName, dataValues[i].ChillerStatus, new Date(dataValues[i].StartTime), new Date(dataValues[i].EndTime));
            }
            var options = {
                    ...
                    <center>
                           <div class="row"  >
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center  bhoechie-tab-container" style="border:solid 0px Black;">
                                       <h1><asp:Label ID="lblHeader" runat="server" Text="Chillers Pump Status"></asp:Label>
                                           <a href="CheckStatus.aspx?PID=2" target="_blank" title="Click here to enlarge the chart in seperate window"><img src="Images/retro-tv-icon.jpg" style="width:50px; height:40px" /></a>
                                       <br />
                      <asp:Label runat="server" ID="lblMShift"  Font-Size="Medium" ForeColor="Black"      ></asp:Label>
                                       </h1>
                                      <div class="row" style="padding-left:35px;padding-right:35px; border:solid 0px Black;"> 
                                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="border:solid 0px Black;">
                                          <div id="CHLChart"   style="width:780px; height:1150px;"    ></div>  
                                              </div>
                                      ...
                                      <div class="row" style="padding-left:35px;padding-right:35px;" > 
                                           ...
                                           <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                        <asp:RadioButtonList runat="server" ID="rdoYN" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdoCHLPump_SelectedIndexChanged">
