<%@ Page Title="" Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="CheckStatusAll.aspx.cs" Inherits="ShiftTurnover.CheckStatusAll" %>
        ...
        $(document).ready(function () {
          ...
          // alert('shiftID=' + shiftID);
            $.ajax({
                ...
                url: 'CheckStatusAll.aspx/GetChillerData',
             ...
             $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'CheckStatusAll.aspx/GetChillerPumpData',
                data: '{"shiftID":"' + shiftID +  '"}',
                success:
                    function (response) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'CheckStatusAll.aspx/GetBlrData',
                 data: '{"shiftID":"' + shiftID +  '"}',
                success:
                    function (response) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'CheckStatusAll.aspx/GetFreeCoData',
                 data: '{"shiftID":"' + shiftID +  '"}',
                success:
                    function (response) {
             ...
             $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'CheckStatusAll.aspx/GetROPumpData',
                data: '{"shiftID":"' + shiftID +  '"}',
                success:
                    function (response) {
             ...
             $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'CheckStatusAll.aspx/GetCTData',
                 data: '{"shiftID":"' + shiftID +  '"}',
                success:
                    function (response) {
    ...
    <asp:Table ID="tblStatus" runat="server" CssClass="wiznavbuttons" CellPadding="0" CellSpacing="0" BorderWidth="0" Width="800" HorizontalAlign="Center">
        <asp:TableRow>
            <asp:TableCell>
                           ...
                           <div id="CHLPumpChart"  style="height:1150px;"    ></div>
                           <br /><hr /><br />
                          <strong>Cooling Tower Status </strong>:  
                           <div id="CTChart" style="height:1150px;"  ></div>
                           <br /><hr /><br />
                            <strong>Free Cooling Status </strong>:  
                          <div id="FreeCoChart"  style="height:400px;" ></div>
                          <br /><hr /><br />
                          <strong>Boiler Status </strong>:  
                          <div id="BlrChart" style="height:540px;"   ></div>
