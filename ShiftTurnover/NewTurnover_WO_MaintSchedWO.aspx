<%@ Page Title="" Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="NewTurnover_WO_MaintSchedWO.aspx.cs" Inherits="ShiftTurnover.NewTurnover_WO_MaintSchedWO" %>
   ...
   <script>
       ...
       $(document).ready(function () {
           ...
           $('#example').DataTable({
               ...
               "iDisplayLength": 50,
               "oLanguage": {
                   "sEmptyTable": "No work orders found with given parameters!!"
               }
           });
...
<asp:Content ID="Content16" ContentPlaceHolderID="cph_main" runat="server">
    <div class="container" >
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center  bhoechie-tab-container">
                    <center>
                        <div class="row"  >
                                 ...
                                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center  bhoechie-tab-container" style="border:solid 0px Black;">
                                    ...
                                    <asp:Table ID="Table6" runat="server" CssClass="wiznavbuttons" CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="Center" Width="800">
                                         <asp:TableRow>
                                                            <asp:TableCell>
                                                                <h1><asp:Label ID="lblHeader" runat="server"  ForeColor="#9A0000" Font-Bold="true" Text="Maintenance Schedule Work Orders"></asp:Label>
                                            ...
                                            <asp:TableCell>
                                                <fieldset class="fs-border">
                                                    ...
                                                    <asp:Table ID="Table17" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="Center" Width="760">
                                                        <asp:TableRow>
                                                            <asp:TableCell>
                                                                <asp:Label ID="lblWO" ForeColor="Green" runat="server">There are no Schedule Maintenance Work Orders for this shift.</asp:Label>
                                                        ...
                                                        <asp:TableRow>
                                                            <asp:TableCell  HorizontalAlign="Left">
                                                                <asp:Label ID="Label1" runat="server" Font-Bold="true">
                                                                        The work orders shown here are scheduled to be completed during the next shift, except water chemistry. 
                                                      Are all the required maintenance work orders correct?
                                                                </asp:Label>
                                                                <img height="12" alt="Required" src="Images/icon_required.gif" width="13" />
                                                            </asp:TableCell>
                                                            <asp:TableCell>
                                                                 <asp:RadioButtonList runat="server" ID="rdoWOOther" RepeatDirection="Horizontal">
                                                            <asp:ListItem Value="Yes" Text="&nbsp;Yes&nbsp;"></asp:ListItem>
                                                            <asp:ListItem Value="No" Text="&nbsp;No&nbsp;"></asp:ListItem>
                                                        </asp:RadioButtonList>
                                                                <asp:RequiredFieldValidator Display="Dynamic" CssClass="alert" ControlToValidate="rdoWOOther" ErrorMessage="Required" ID="rfvYN" runat="server"  ></asp:RequiredFieldValidator>
                                                            </asp:TableCell>
                                                        </asp:TableRow>
