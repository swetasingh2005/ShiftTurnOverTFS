<%@ Page Title=" " Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="NewTurnover_ChlStatus.aspx.cs" Inherits="ShiftTurnover.NewTurnover_ChlStatus" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: 'NewTurnover_ChlStatus.aspx/GetData',
                data: '{}',
                success:
                    function (response) {
...
<asp:Content ID="Content16" ContentPlaceHolderID="cph_main" runat="server">
    ...
    <div class="container">
        <div id="loadingGif" style="display: none; position: fixed; z-index: 1031; top: 50%; right: 50%; margin-top: 100px; margin-right: -100px;">
                ...
                <center>
                           <div class="row"  >
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center  bhoechie-tab-container" style="border:solid 0px Black;">
                                       <h1><asp:Label ID="lblHeader" runat="server" Text="Chillers  Status"></asp:Label>
                                           <a href="CheckStatus.aspx?PID=1" target="_blank" title="Click here to enlarge the chart in seperate window"><img src="Images/retro-tv-icon.jpg" style="width:50px; height:40px" /></a>
                                           <br />
                      <asp:Label runat="server" ID="lblMShift"  Font-Size="Medium" ForeColor="Black"      ></asp:Label>
                                  ...
                                  <asp:UpdatePanel runat="server" ID="updData"  UpdateMode="Conditional">
                                      ...
                                      <div class="row" style="padding-left:35px;padding-right:35px;" > 
                                           ...
                                           <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                        <asp:RadioButtonList runat="server" ID="rdoYN" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdoChiller_SelectedIndexChanged">
                                          ...
                                          <asp:RequiredFieldValidator Display="Dynamic" CssClass="alert"  Enabled="false" 
                                              ControlToValidate="txtComment" ErrorMessage="Required" ID="rfvComment" runat="server" ></asp:RequiredFieldValidator>
                                               </div>
                                      </div>
                                          <div class="row" style="padding-left:35px;padding-right:35px;" > 
                                           <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                  <div><strong>Was Optimization Plan Followed?</strong><img height="12" alt="Required" src="Images/icon_required.gif" width="13" /></div>

                                           </div>
                                           <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                        <asp:RadioButtonList runat="server" ID="rdlOptimization" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdlOptimization_SelectedIndexChanged">
                                                            <asp:ListItem Value="Yes" Text="&nbsp;Yes&nbsp;"></asp:ListItem>
                                                            <asp:ListItem Value="No" Text="&nbsp;No&nbsp;"></asp:ListItem>
                                                        </asp:RadioButtonList>
                                                 <asp:RequiredFieldValidator Display="Dynamic" CssClass="alert" ControlToValidate="rdlOptimization" ErrorMessage="Required" ID="RequiredFieldValidator1" runat="server"  ></asp:RequiredFieldValidator>
                                           </div>
                                           <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                               <div> <asp:Label ID="lblOptimization" runat="server" Visible="false" Font-Bold="true" Text="Please enter a comment if the Optimization Plan was not Followed:"></asp:Label>
                                                    
                                                   </div>
                                               </div>
                                           <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                           <asp:TextBox ID="txtOptimizationComment" TabIndex="11" runat="server" Visible="false" CssClass="form-control"   Rows="3"   TextMode="MultiLine"></asp:TextBox> 
                                          <asp:RequiredFieldValidator Display="Dynamic" CssClass="alert"  
                                              Enabled="false" ControlToValidate="txtOptimizationComment"
                                              ErrorMessage="Required" ID="rfvOptimizationComment" runat="server" ></asp:RequiredFieldValidator>
                                               </div>
                                      </div>               
                               <br />
