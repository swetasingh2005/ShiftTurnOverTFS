<%@ Page Title="" Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="NewTurnover_WO_WCWO.aspx.cs" Inherits="ShiftTurnover.NewTurnover_WO_WCWO" %>
                         ...
                         <div class="row"  >
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center  bhoechie-tab-container" style="border:solid 0px Black;">
                                    ...
                                    <asp:Table ID="Table6" runat="server" CssClass="wiznavbuttons" CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="Center" Width="800">
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                 <h1 ><asp:Label ID="lblHeader"  runat="server" ForeColor="#9A0000" Font-Bold="true" Text="Water Chemistry Work Orders"></asp:Label>
                                            ...
                                            <asp:TableCell>
                                                <fieldset class="fs-border">
                                                    ...
                                                    <asp:Table ID="Table17" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="Center" Width="760">
                                                        <asp:TableRow>
                                                            <asp:TableCell>
                                                                <asp:Label ID="lblWO" runat="server" ForeColor="Green">There are no Water Chemistry Work Orders for this shift.</asp:Label>
                                            ...
                                            <asp:TableCell>
                                                <fieldset class="fs-border">
                                                    ...
                                                    <asp:Table ID="Table2" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="left" Width="760">
                                                        <asp:TableRow>
                                                            <asp:TableCell  HorizontalAlign="Left" Wrap="true" Width="350px">
                                                                <asp:Label ID="Label1" runat="server" Font-Bold="true">
                                                                 The water chemistry work orders shown here are scheduled to be completed in the next shift. Are these work orders correct?
                                                                </asp:Label>
