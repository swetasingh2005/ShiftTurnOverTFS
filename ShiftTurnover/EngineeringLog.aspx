<%@ Page Title="Shift Turnover Engineering Log " Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="EngineeringLog.aspx.cs" Inherits="ShiftTurnover.EngineeringLog" %>
...
<asp:Content ID="Content14" ContentPlaceHolderID="cph_instructions" runat="server">
     <div runat="server" id="divExisting" class="instructions">
        ...
        <strong>Engineering Log Instructions</strong>: Enter Event Date/Time and Details below and click the Submit button. 
...
<asp:Content ID="Content16" ContentPlaceHolderID="cph_main" runat="server">
            ...
            <asp:TableCell>
                <asp:Panel runat="server" ID="pnlLiveLog">
                    <fieldset class="fs-border">
                        <legend class="fs-border">Engineering Log Submission Form</legend>
                        <asp:Table ID="tblSelectSection" runat="server"  CellPadding="20" CellSpacing="4" BackColor="#e2e2e2" BorderWidth="1">
                             <asp:TableRow>
                            <asp:TableCell   ColumnSpan="3">
                            <asp:Label ID="lblLiveLogID1" runat="server" Font-Bold="true" Text="Enter New Log" ForeColor="Green" ></asp:Label>
    ...
    CssClass="wiznavbuttons" CellPadding="0" CellSpacing="0"  
        ...
        <asp:TableRow>
            <asp:TableCell>
                <fieldset class="fs-border">
                    <legend class="fs-border">All  Engineering Logs</legend>
                                                ...
                                                <asp:DataGrid ID="GrPast" runat="server" CssClass="listing" HorizontalAlign="Center" UseAccessibleHeader="True"
                                                   AutoGenerateColumns="false"  BorderColor="Black" CellPadding="4" CellSpacing="0"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="EngineeringLogID" Visible="true" HeaderText="Engineering Log ID"></asp:BoundColumn>
