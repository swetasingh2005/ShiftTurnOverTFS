<%@ Page Title="Chiller Statuses" Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="ChillerStatus.aspx.cs" Inherits="ShiftTurnover.ChillerStatus" %>
                    ...
                    <fieldset class="fs-border">
                        ...
                        <asp:Table ID="tblCHLStatus" runat="server" CellPadding="0" CellSpacing="4" BorderWidth="0">
                            <asp:TableRow>
                                ...
                                <asp:TableCell RowSpan="2" VerticalAlign="Middle" Width="800">
                                    <uc1:ucChillerChart runat="server" id="ucChillerChart" />
