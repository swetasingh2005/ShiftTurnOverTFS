<%@ Page Title=" " Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="NewTurnover_CTStatus.aspx.cs" Inherits="ShiftTurnover.NewTurnover_CTStatus" %>
         ...
         ShowProgress();
             $.ajax({
                ...
                contentType: 'application/json',
                 url: 'NewTurnover_CTStatus.aspx/GetData',
                data: '{}',
                success:
                    function (response) {
                    ...
                    <center>
                           <div class="row"  >
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center  bhoechie-tab-container" style="border:solid 0px Black;">
                                       <h1><asp:Label ID="lblHeader" runat="server" Text="Cooling Towers Status"></asp:Label>
                                           <a href="CheckStatus.aspx?PID=3" target="_blank" title="Click here to enlarge the chart in seperate window"><img src="Images/retro-tv-icon.jpg" style="width:50px; height:40px" /></a>
                                       <br />
                      <asp:Label runat="server" ID="lblMShift"  Font-Size="Medium" ForeColor="Black"      ></asp:Label>
                                    ...
                                    <asp:UpdatePanel runat="server" ID="updData"  UpdateMode="Conditional">
                                      ...
                                      <div class="row" style="padding-left:35px;padding-right:35px;" > 
                                           ...
                                           <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                                        <asp:RadioButtonList runat="server" ID="rdoYN" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rdoCT_SelectedIndexChanged">
