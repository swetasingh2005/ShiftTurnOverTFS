<%@ Page Title="Shift Turnover HVG Log " Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="HVGLog.aspx.cs" Inherits="ShiftTurnover.HVGLog" %>
...
<asp:Content ID="Content14" ContentPlaceHolderID="cph_instructions" runat="server">
     <div runat="server" id="divExisting" class="instructions">
        ...
        <strong>HVG Log Instructions</strong>: Enter Event Date/Time and Details below and click the Submit button. 
...
<asp:Content ID="Content16" ContentPlaceHolderID="cph_main" runat="server">
            ...
            <asp:TableCell>
                <asp:Panel runat="server" ID="pnlLiveLog">
                    <fieldset class="fs-border">
                        <legend class="fs-border">HVG Log Submission Form</legend>
                        <asp:Table ID="tblSelectSection" runat="server"  CellPadding="20" CellSpacing="4" BackColor="#e2e2e2" BorderWidth="1">
                             <asp:TableRow>
                            <asp:TableCell   ColumnSpan="3">
                            <asp:Label ID="lblLiveLogID1" runat="server" Font-Bold="true" Text="Enter New HVG Log" ForeColor="Green" ></asp:Label>
    ...
    CssClass="wiznavbuttons" CellPadding="0" CellSpacing="0"  
        ...
        <asp:TableRow>
            <asp:TableCell>
                <fieldset class="fs-border">
                    <legend class="fs-border">Past 30  HVG Logs</legend>
                    <asp:Table ID="tblPastLog" runat="server" CellPadding="0" CellSpacing="4" BorderWidth="0" HorizontalAlign="Center" Width="960">
                        <asp:TableRow>
                            <asp:TableCell>
                                <asp:Label ID="lblPast" runat="server">There are no reported past HVG logs in last 30 days.</asp:Label>
                                                ...
                                                <asp:DataGrid ID="GrPast" runat="server" CssClass="listing" HorizontalAlign="Center" UseAccessibleHeader="True"
                                                   AutoGenerateColumns="false"  BorderColor="Black" CellPadding="4" CellSpacing="0"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="HVGLogID" Visible="true" HeaderText="HVG Log ID"></asp:BoundColumn>
