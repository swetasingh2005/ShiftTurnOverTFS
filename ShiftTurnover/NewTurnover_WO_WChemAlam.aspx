<%@ Page Title="" Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="NewTurnover_WO_WChemAlam.aspx.cs" Inherits="ShiftTurnover.NewTurnover_WO_WChemAlam" %>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-left  bhoechie-tab-container">
                    <center>
                                            ...
                                            <asp:TableCell>
                                                <fieldset class="fs-border">
                                                    ...
                                                    <asp:Table ID="Table17" runat="server" CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="Center" Width="760">
                                                        <asp:TableRow>
                                            <asp:TableCell>
                              <h1><asp:Label ID="lblHeader" runat="server"  ForeColor="#9A0000" Font-Bold="true" Text="Water Chemistry Critical Alarms"></asp:Label>
                      ...
                      <asp:Label runat="server" ID="lblMShift"  Font-Size="Medium" ForeColor="Black"      ></asp:Label>
                                                        ...
                                                        <asp:TableRow>
                                                            <asp:TableCell>
                                                                <asp:Label ID="lblWO" runat="server" ForeColor="Green">There are no Water Chemistry Critical Alarms for this shift.</asp:Label>
                                    ...
                                    <div class="row" style="margin-top:20px; border:solid 0px black;"  > 
                                        ...
                                        <asp:TableRow>
                                                        ...
                                                        <asp:TableRow>
                                                            <asp:TableCell  HorizontalAlign="Left">
                                                                <asp:Label ID="Label1" runat="server" Font-Bold="true">
                                                                   Are all chemical alarms correct?
                                                                </asp:Label>
                                            ...
                                            </fieldset></asp:TableCell></asp:TableRow></asp:Table>
