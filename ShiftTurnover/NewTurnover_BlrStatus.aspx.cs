...
{
    public partial class NewTurnover_BlrStatus : System.Web.UI.Page
    {
        ...
        protected void LoadStatus()
        {
            try
            {
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            rdoYN.SelectedValue = row["BoilerYN"].ToString();
                            txtComment.Text = row["BoilerComments"].ToString();
                        }
            ...
            {
                ErrorHandler.LogErrorToDB((int)Session["personid"], "NewTurnover_BlrStatus.LoadStatus", "SelectReportDetails", ex);
        ...
        protected void rdoBoiler_SelectedIndexChanged(object sender, EventArgs e)
        {
            ShowHideComment(rdoYN.SelectedValue);
        }
        ...
        protected void SaveStatus( )
        {
            try
            {
                ...
                _dm.AddParameter("@BoilerYN", SqlDbType.VarChar, rdoYN.SelectedValue);
                _dm.AddParameter("@BoilerComments", SqlDbType.VarChar, Comments);
                _dm.ExecuteCommand("AddEditReportInfo");
            }
            catch (Exception ex)
            {
                ErrorHandler.LogErrorToDB(18, "NewTurnOver_BlrStatus.SaveStatus", "AddEditReportInfo", ex);
