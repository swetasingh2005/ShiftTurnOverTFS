...
namespace ShiftTurnover
{
    public partial class ManageUser : System.Web.UI.Page
    {
        ...
        private void DeleteUser(int ID)
        {
            ...
            {
                ErrorHandler.LogErrorToDB(personroleid, ID, "Manageuser.DeleteUser" + ex.Message, "deleteuser", ex);
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        foreach (DataRow row in ds.Rows)
                        {
                            ...
                            if (_attID > 0)
                            {
                                ViewURL = "ManageUser.aspx?update=delete&";
                                strBody.Append("<a target='_self' href=\"" + ViewURL + "ID=" + _attID + "\"><img src=" + uDel + " alt='edit' width='30' height='30' title='Click here to deactivate the user '  /></a> ");
                            }
                            strBody.AppendLine();
                            EditURL = "AddEditUser.aspx?";
                    ...
                    {
                        ErrorHandler.LogErrorToDB((int)Session["personroleid"], "Manageuser.LoadSmartGrid", "SelectPersonRoleListALL", ex);
                        Response.Redirect("CustomErrorPage.aspx");
                    }
                    finally
                    {
