...
namespace ShiftTurnover
{
    public partial class CheckStatus : System.Web.UI.Page
    {
        ...
        protected void ShowHidePanel(int PID, string mode)
        {
            switch (PID)
            {
                case 1: //
                    pnlCHLStatus.Visible = true;
                    pnlChrPmpStatus.Visible = false;
                    pnlCTStatus.Visible = false;
                    pnlFreeCoStatus.Visible = false;
                    pnlBlrStatus.Visible = false;
                    pnlROPumpStatus.Visible = false;
                    break;
                case 2: //
                   
                    pnlCHLStatus.Visible = false;
                    pnlChrPmpStatus.Visible = true;
                    pnlCTStatus.Visible = false;
                    pnlFreeCoStatus.Visible = false;
                    pnlBlrStatus.Visible = false;
                    pnlROPumpStatus.Visible = false;
