<%@ Page Title="Boiler Alarm Benchmarking Analysis and Results" Language="C#" MasterPageFile="~/ShiftTurnover.Master" AutoEventWireup="true" CodeBehind="BenchMarkingReport.aspx.cs" Inherits="ShiftTurnover.BenchMarkingReport" %>
...
<asp:Content ID="Content13" ContentPlaceHolderID="cph_main" runat="server">
    ...
    <div class="row" style="margin-top: 20px; border: solid 0px black;">
        <asp:Table ID="Table1" runat="server" CssClass="wiznavbuttons" CellPadding="0" CellSpacing="0" BorderWidth="0" HorizontalAlign="Center" Width="860">
            <asp:TableRow>
                <asp:TableCell>
                     <asp:Button ID="btnCalculate" runat="server" Text="Calculate Values" OnClick="btnCalculate_Click" />
                </asp:TableCell>
                <asp:TableCell>
                     <asp:Label ID="lblCounter" runat="server" ></asp:Label>
                     <asp:DataGrid ID="grdResult" runat="server" CssClass="listing" HorizontalAlign="Center" 
                                                AutoGenerateColumns="true" ItemStyle-Wrap="true" Width="1000" 
